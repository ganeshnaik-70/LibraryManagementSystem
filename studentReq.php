    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark p-3">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="studentReq.php">Your Requests</a>
                </li>
            </ul>
            <li class="navbar-nav mt-2 mt-lg-0">
                <a class="nav-link btn btn-primary btn-sm text-white" href="signin.html">Logout</a>
            </li>
        </div>
    </nav>
            ...
            <div class="request" id="req">
                ...
                <div class="query" id="querys">
                    ...
                    <p>
                        ...
                        Status: <span class="status"><?php echo $status ?></span><br>
                    </p>
                    <?php
                        if($status=="accept"){

                    ?>
                            <form class="buttons" method="POST" action="payment.php">
                                <input type="text" name="bid" value="<?php echo $rowsb['bid']; ?>" style="display:none;">
                                <button type="submit" name="pay" class="btn btn-success submit">Buy Now</button>
                            </form>
                    <?php
                        }
                        if($status=="dissmis"){
